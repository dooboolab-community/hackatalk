# Migration `20200816135927-init`

This migration has been generated by hyochan at 8/16/2020, 10:59:27 PM.
...
ALTER TABLE "hackatalk"."Membership" ADD FOREIGN KEY ("userId")REFERENCES "hackatalk"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE
