...
export const light = {
  ...
  text: colors.dark,
  textSecondaryColor: colors.blue_70,
...
export const dark = {
  ...
  text: colors.light,
  textSecondaryColor: colors.paleBlue_10,
  ...
  modalBackbround: colors.backgroundDark,
  ...
  icon1: colors.green_30,
  icon2: colors.green_30,
};
